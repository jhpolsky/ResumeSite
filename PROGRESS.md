...
| 19 | **CI/CD Status Dashboard** | ⬜ Future | Add GitHub Actions workflow status badges to both repo READMEs. Optionally create a `jhpolsky/jhpolsky` GitHub profile README aggregating both badges in one place — visible to anyone visiting your GitHub profile. Badge URL pattern: `https://github.com/{owner}/{repo}/actions/workflows/{file}.yml/badge.svg` |
...
| 2026-04-16 | 15 | Frontend CI/CD live — `.github/workflows/deploy.yml` syncs index.html/style.css/counter.js to S3 and invalidates CloudFront on every push to master. Both repos now have full CI/CD pipelines. |
